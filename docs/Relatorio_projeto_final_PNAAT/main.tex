...
% ===================== CAMINHO DAS IMAGENS =====================
% Como este .tex fica em docs/ e as imagens em docs/images/,
% basta referenciar o nome do arquivo (ex: \includegraphics{montagem.jpg})
% que o LaTeX já busca automaticamente dentro de docs/images/
\graphicspath{{images/}}
...
% ===================== COMANDO PARA FIGURA (com fallback) =====================
% Uso: \projimg{nome-do-arquivo}{Legenda da imagem}
% Se o arquivo nao existir em docs/images/, mostra uma caixa de placeholder
% em vez de quebrar a compilacao.
\newcommand{\projimg}[2]{%
...
\projimg{montagem.jpg}{Foto da montagem real com jumpers visíveis}
\projimg{esquematico.jpg}{Diagrama esquemático/Fritzing da ligação BNO085 $\leftrightarrow$ Heltec}
...
\projimg{edge-impulse-studio.png}{Capturas de tela do Edge Impulse Studio — explorador de dados, acurácia/perda, matriz de confusão}
\projimg{amostra-gesto.png}{Gráfico de uma amostra de gesto mostrando variação de pitch/yaw}
...
\projimg{impulse-design.png}{Tela de configuração do Impulse no Edge Impulse Studio}
\projimg{classifier-training.png}{Tela de treinamento do classificador com matriz de confusão}
